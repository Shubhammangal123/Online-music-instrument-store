...
def process_order_and_payment(selected_product, shipping_address, payment_method):
    ...
    payment_successful = tk.messagebox.askyesno("Payment Confirmation", f"Total Amount: ${selected_product['price']}\nPayment Method: {payment_method}\n\nProceed with payment?")
    if payment_successful:
        order_status_label.config(text="Order placed successfully. Notification will be sent.")
        show_notification("Order Placed", "Your order has been placed successfully.")
        # Here, you can handle order processing (e.g., store order details in a database).
        cart.clear()
        update_cart_display()
...
def update_user_profile():
    ...
    user_details["email"] = updated_email
    user_details["phone"] = updated_phone
...
product_listbox = tk.Listbox(product_catalog_frame)
product_listbox.pack(side="left", fill="both", expand=True)

product_details_label = tk.Label(product_catalog_frame, text="")
...
cart_label = ttk.Label(cart_frame, text="Shopping Cart")
cart_label.pack()

cart_listbox = tk.Listbox(cart_frame)
cart_listbox.pack(side="left", fill="both", expand=True)

cart_total_label = ttk.Label(cart_frame, text="")
...
order_status_label = ttk.Label(cart_frame, text="")
